...
signal_freq_lbl.grid(row = 0, column = 1, sticky = ('E', 'S'), padx = (20, 5), pady = 5)
...
signal_amp_lbl.grid(row = 1, column = 1, sticky = 'E', padx = (20, 5))
...
signal_phase_lbl.grid(row = 2, column = 1, sticky = ('E', 'N'), padx = (20, 5), pady = 5)
...
carry_freq_lbl.grid(row = 3, column = 1, sticky = ('E', 'S'), padx = (20, 5), pady = 5)
carry_freq = tk.IntVar()
carry_freq.set(40)
carry_freq_box = tk.Spinbox(root, from_ = 1, to = 100, textvariable = carry_freq, font = font_, foreground = foreground_, command = carry_freq_change)
...
carry_amp_lbl.grid(row = 4, column = 1, sticky = ('E'), padx = (20, 5), pady = 5)
carry_amp = tk.IntVar()
carry_amp.set(50)
carry_amp_box = tk.Spinbox(root, from_ = 5, to = 300, textvariable = carry_amp, font = font_, foreground = foreground_, command = carry_amp_change, increment = 5.0)
...
carry_phase_lbl.grid(row = 5, column = 1, sticky = ('E', 'N'), padx = (20, 5), pady = 5)
...
type_m_lbl.grid(row = 7, column = 1, sticky = 'E', padx = (20, 5))
type_m = tk.StringVar()
type_modulation = ttk.Combobox(root, state = 'readonly', textvariable = type_m , font = font_)
type_modulation.grid(row = 7, column = 2, sticky = ('W', 'E'), padx = 2, pady = 20)
